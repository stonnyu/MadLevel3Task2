...
class CustomTabHelper {
    ...
    fun getPackageNameToUse(context: PortalsFragment, url: String): String? {
    ...
    private fun hasSpecializedHandlerIntents(context: PortalsFragment, intent: Intent): Boolean {
        try {
            val pm = context.activity?.getPackageManager()
